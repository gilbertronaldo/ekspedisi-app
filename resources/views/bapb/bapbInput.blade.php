                ...
                <div class="card">
                    <form class="form-horizontal r-separator">
                        ...
                        <div class="card-body bg-light">
                                        ...
                                        <div class="col-md-12 d-flex justify-content-end">
                                            <div class="custom-control custom-checkbox h5">
                                                <input type="checkbox" class="custom-control-input"
                                                       id="input-full-container"
                                                       ng-model="vm.input.full_container"
                                                       ng-init="vm.input.full_container = false">
                                                <label class="custom-control-label" for="input-full-container">FULL
                                                    CONTAINER</label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12" ng-if="vm.input.full_container">
                                    <div class="pl-5 pt-3">
                                        <h6 class="card-title m-t-10 p-b-20">Barang</h6>
                                        <div>
                                            <table class="table table-bordered">
                                                <caption class="text-right">
                                                    <a class="btn btn-circle btn-outline-warning btn-sm text-dark"
                                                       ng-click="vm.fullContainerItemPop()" style="padding: 0.5em"><i
                                                            class="mdi mdi-minus"></i></a>
                                                    <a class="btn btn-circle btn-outline-info btn-sm text-dark"
                                                       ng-click="vm.fullContainerItemPush()" style="padding: 0.5em"><i
                                                            class="mdi mdi-plus"></i></a>
                                                </caption>
                                                <thead>
                                                <tr class="text-center">
                                                    <th scope="col" width="10%">#</th>
                                                    <th scope="col" width="40%">Pengirim</th>
                                                    <th scope="col" width="40%">Nama Barang</th>
                                                    <th scope="col" width="10%">Koli</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <tr ng-repeat="item in vm.fullContainer.items"
                                                    ng-init="senderIdx = $index">
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-12">
                                                                <sc-select
                                                                    ...
                                                                    ng-change="vm.getSenderDetailFullContainer(senderIdx)"
                                                        ...
                                                        <div class="form-group row">
                                                            <label
                                                                class="col-sm-12 text-left control-label col-form-label small">Nama
                                                                di
                                                                BAPB
                                                            </label>
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control"
                                                                       ng-model="item.sender_detail.sender_name_bapb"
                                                                       placeholder="" ng-disabled="true">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input class="form-control " type="number"  ng-model="item.koli"
                                                               ng-change="vm.fullContainerCalculate()">
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                               ...
                                               <table class="table table-bordered">
                                                   <tr>
                                                       <th>
                                                           <div>
                                                               <label
                                                                   class="col-sm-5 text-left control-label col-form-label">Biaya FULL CONTAINER</label>
                                                               <div class="col-sm-7">
                                                                   <input class="form-control " type="text"
                                                                          ng-model="vm.fullContainer.price" ui-currency
                                                                          ng-change="vm.fullContainerCalculate()">
                                                               </div>
                                                           </div>
                                                       </th>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group row">
                                                    <label
                                                        class="col-sm-12 text-left control-label col-form-label">Biaya
                                                        Lain
                                                        Lain</label>
                                                </div>
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <caption class="text-right">
                                                            <a class="btn btn-circle btn-outline-warning btn-sm text-dark"
                                                               ng-click="vm.fullContainerCostPop()"
                                                               style="padding: 0.5em"><i
                                                                    class="mdi mdi-minus"></i></a>
                                                            <a class="btn btn-circle btn-outline-info btn-sm text-dark"
                                                               ng-click="vm.fullContainerCostPush()"
                                                               style="padding: 0.5em"><i
                                                                    class="mdi mdi-plus"></i></a>
                                                        </caption>
                                                        <thead>
                                                        ...
                                                        <tbody>
                                                        <tr ng-repeat="sCost in vm.fullContainer.costs"
                                                            ng-init="sCostIdx = $index">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                            <textarea type="text" class="form-control"
                                                      ng-model="vm.fullContainer.description"
                                ...
                                <div class="col-md-12" ng-if="!vm.input.full_container">
                                    <div class="pl-5 pt-3" ng-repeat="sender in vm.senders"
                                         ng-init="senderIdx = $index">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <caption class="text-right">
                                                            <a class="btn btn-circle btn-outline-warning btn-sm text-dark"
                                                               ng-click="vm.senderCostPop(senderIdx)"
                                                               style="padding: 0.5em"><i
                                                                    class="mdi mdi-minus"></i></a>
                                                            <a class="btn btn-circle btn-outline-info btn-sm text-dark"
                                                               ng-click="vm.senderCostPush(senderIdx)"
                                                               style="padding: 0.5em"><i
                                                                    class="mdi mdi-plus"></i></a>
                                                        </caption>
                                                        <thead>
                                                        ...
                                                        <tbody>
                                                        <tr ng-repeat="sCost in sender.costs"
                                                            ng-init="sCostIdx = $index">
                                                            <th scope="row">{{'{{'. 'sCostIdx + 1' .'}'.'}'}}</th>
                                                            <td>
                                                                <input class="form-control " type="text"
                                                    ...
                                                    <div class="col-md-8 offset-2">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-7 text-left"
                                                                ...
                                                                <code
                                                                    ng-if="sender.detail.minimum_charge_calculation_id == 1">
                                                                    {{'{{'. 'sender.detail.minimum_charge / 1000' .'}'.'}'}}
                                                                    <span>m<sup>3</sup></span>
                                                                </code>
                                                                <code
                                                                    ng-if="sender.detail.minimum_charge_calculation_id == 2">
                                                                    {{'{{'. 'sender.detail.minimum_charge | currency:"Rp.":0' .'}'.'}'}}
                                                                </code>
                                                                <code
                                                                    ng-if="sender.detail.minimum_charge_calculation_id == 3">
                                                            ...
                                                            <div class="col-sm-7 text-left"
                                                                 ng-if="vm.input.tagih_di != 'sender'">
                                                                <code
                                                                    ng-if="vm.detail.calculation.minimum_charge_calculation_id == 1">
                                                                    {{'{{'. 'vm.detail.calculation.minimum_charge / 1000' .'}'.'}'}}
                                                                    <span>m<sup>3</sup></span>
                                                                </code>
                                                                <code
                                                                    ng-if="vm.detail.calculation.minimum_charge_calculation_id == 2">
                                                                    {{'{{'. 'vm.detail.calculation.minimum_charge | currency:"Rp.":0' .'}'.'}'}}
                                                                </code>
                                                                <code
                                                                    ng-if="vm.detail.calculation.minimum_charge_calculation_id == 3">
                                        ...
                                        <div class="row" ng-if="senderIdx == vm.senders.length - 1">
                                            <div class="col-md-12 pull-right text-right">
                                                <button class="btn btn-dark btn-circle" ng-click="vm.senderPop()">-
                                                </button>
                                                <button class="btn btn-default btn-circle" ng-click="vm.senderPush()">
                                                    +
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label"
                                                       for="input-calculation">Kalkulasi</label>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="custom-control custom-checkbox">
                                        ...
                                        <div class="col-md-12">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="input-price"
                                                       ng-model="vm.input.show_price"
                                                       ng-init="vm.input.show_price = true">
                                ...
                                <div class="col-sm-12 col-lg-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            <thead>
                                            <tr class="text-center">
                                                <th scope="col" ng-if="!vm.input.full_container">Penerima</th>
                                                <th scope="col" ng-if="!vm.input.full_container">Pengirim</th>
                                                <th scope="col">Total Koli</th>
                                                <th scope="col" ng-if="!vm.input.full_container">Dimensi Total</th>
                                                <th scope="col" ng-if="!vm.input.full_container">Berat Total</th>
                                            ...
                                            <tr class="text-center" ng-repeat="sender in vm.senders"
                                                ng-init="senderIdx = $index" ng-if="sender.sender_id && !vm.input.full_container">
                                            ...
                                            <tr class="text-center">
                                                <td colspan="2" ng-if="!vm.input.full_container">
                                                    Total Keseluruhan
                                                </td>
                                                <td>
                                                    <code>{{'{{'. 'vm.input.total.koli | currency:"":0' .'}'.'}'}}</code>&nbsp;<span>Koli</span>
                                                </td>
                                                <td ng-if="!vm.input.full_container">
                        ...
                        <div class="card-body">
                            <div class="form-group m-b-0 text-right">
                                ...
                                <button type="submit" class="btn btn-primary waves-effect waves-light"
                                        ng-if="vm.can_edit"
                                        ng-click="vm.onSubmit()" ng-disabled="isSaving"><i ng-if="isSaving"
