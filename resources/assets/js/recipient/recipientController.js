;(() => {
    ...
    function RecipientController($state, $scope, swangular, $q, DTOptionsBuilder, DTColumnBuilder, $localStorage, $compile, RecipientService) {
        ...
        vm.dtColumns = [
            ...
            DTColumnBuilder.newColumn('recipient_name_other').withTitle('Nama Penerima Lainnya'),
            DTColumnBuilder.newColumn('recipient_phone').withTitle('Telepon').withOption('width', '10%'),
